...
import IstadLogo from '../../images/Logo';
import Link from 'next/link';


export default function NavbarComponent() {
  return (
    <Navbar fluid rounded className='bg-[#253D94] rounded-none'>
      <div className='w-full flex flex-wrap items-center justify-between'>
        ...
        <Navbar.Collapse className='p-4 font-bold mt-4 lg:mt-0'>
          ...
          <Navbar.Link href="ITNews" className='text-white text-lg font-bold block mb-4 lg:inline-block lg:mb-0 mr-4'>
            IT News
          </Navbar.Link>
